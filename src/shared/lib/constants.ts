...
export const RESUME_BUTTON_TEXT = "Скачать резюме";
export const USER_STATUS = "Доступен для новых проектов";

export const QUOTE = "Let's get dangerous!";
export const QUOTE_AUTHOR = "Darkwing Duck";

export const ABOUT_HELLO = "Привет, меня зовут";
export const ABOUT_DESCRIPTION = [
  "Я фронтенд-разработчик, живу в Сургуте, Россия. Я могу разрабатывать адаптивные веб-сайты с нуля и превращать их в современные, удобные для пользователя веб-приложения. ",
  "Вот уже несколько лет я имею сильное желание воплотить свой творческий потенциал и знания в веб-сайтах. Я всегда стремлюсь узнать о новейших технологиях и фреймворках.",
];
